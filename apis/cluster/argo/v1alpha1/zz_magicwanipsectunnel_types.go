...
type MagicWANIPSecTunnelHealthCheckObservation struct {
...
type MagicWANIPSecTunnelHealthCheckParameters struct {
...
type MagicWANIPSecTunnelInitParameters struct {
	...
	HealthCheck *MagicWANIPSecTunnelHealthCheckInitParameters `json:"healthCheck,omitempty" tf:"health_check,omitempty"`
...
type MagicWANIPSecTunnelObservation struct {
	...
	// (Attributes) (see below for nested schema)
	HealthCheck *MagicWANIPSecTunnelHealthCheckObservation `json:"healthCheck,omitempty" tf:"health_check,omitempty"`
...
type MagicWANIPSecTunnelParameters struct {
	...
	// (Attributes) (see below for nested schema)
	// +kubebuilder:validation:Optional
	HealthCheck *MagicWANIPSecTunnelHealthCheckParameters `json:"healthCheck,omitempty" tf:"health_check,omitempty"`
...
// MagicWANIPSecTunnelSpec defines the desired state of MagicWANIPSecTunnel
type MagicWANIPSecTunnelSpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     MagicWANIPSecTunnelParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider MagicWANIPSecTunnelInitParameters `json:"initProvider,omitempty"`
}

// MagicWANIPSecTunnelStatus defines the observed state of MagicWANIPSecTunnel.
type MagicWANIPSecTunnelStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        MagicWANIPSecTunnelObservation `json:"atProvider,omitempty"`
}
...
// MagicWANIPSecTunnel is the Schema for the MagicWANIPSecTunnels API.
...
type MagicWANIPSecTunnel struct {
	...
	Spec   MagicWANIPSecTunnelSpec   `json:"spec"`
	Status MagicWANIPSecTunnelStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// MagicWANIPSecTunnelList contains a list of MagicWANIPSecTunnels
type MagicWANIPSecTunnelList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []MagicWANIPSecTunnel `json:"items"`
}

// Repository type metadata.
var (
	MagicWANIPSecTunnel_Kind             = "MagicWANIPSecTunnel"
	MagicWANIPSecTunnel_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: MagicWANIPSecTunnel_Kind}.String()
	MagicWANIPSecTunnel_KindAPIVersion   = MagicWANIPSecTunnel_Kind + "." + CRDGroupVersion.String()
	MagicWANIPSecTunnel_GroupVersionKind = CRDGroupVersion.WithKind(MagicWANIPSecTunnel_Kind)
)

func init() {
	SchemeBuilder.Register(&MagicWANIPSecTunnel{}, &MagicWANIPSecTunnelList{})
}
