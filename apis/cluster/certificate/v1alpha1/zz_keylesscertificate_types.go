...
type KeylessCertificateInitParameters struct {
	...
	Tunnel *KeylessCertificateTunnelInitParameters `json:"tunnel,omitempty" tf:"tunnel,omitempty"`
...
type KeylessCertificateObservation struct {
	...
	// (Attributes) Configuration for using Keyless SSL through a Cloudflare Tunnel (see below for nested schema)
	Tunnel *KeylessCertificateTunnelObservation `json:"tunnel,omitempty" tf:"tunnel,omitempty"`
...
type KeylessCertificateParameters struct {
	...
	// (Attributes) Configuration for using Keyless SSL through a Cloudflare Tunnel (see below for nested schema)
	// +kubebuilder:validation:Optional
	Tunnel *KeylessCertificateTunnelParameters `json:"tunnel,omitempty" tf:"tunnel,omitempty"`
...
type KeylessCertificateTunnelInitParameters struct {
...
type KeylessCertificateTunnelObservation struct {
...
type KeylessCertificateTunnelParameters struct {
...
// KeylessCertificate is the Schema for the KeylessCertificates API.
