...
type AccountTokenInitParameters struct {
	...
	Policies []AccountTokenPoliciesInitParameters `json:"policies,omitempty" tf:"policies,omitempty"`
...
type AccountTokenObservation struct {
	...
	// (Attributes Set) Set of access policies assigned to the token. (see below for nested schema)
	Policies []AccountTokenPoliciesObservation `json:"policies,omitempty" tf:"policies,omitempty"`
...
type AccountTokenParameters struct {
	...
	// (Attributes Set) Set of access policies assigned to the token. (see below for nested schema)
	// +kubebuilder:validation:Optional
	Policies []AccountTokenPoliciesParameters `json:"policies,omitempty" tf:"policies,omitempty"`
...
type AccountTokenPoliciesInitParameters struct {
...
type AccountTokenPoliciesObservation struct {
...
type AccountTokenPoliciesParameters struct {
...
type AccountTokenSpec struct {
	...
	// autoscaler.
	InitProvider AccountTokenInitParameters `json:"initProvider,omitempty"`
}
...
// AccountToken is the Schema for the AccountTokens API.
