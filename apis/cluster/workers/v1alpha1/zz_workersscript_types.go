...
type BindingsInitParameters struct {
	...
	KeyBase64SecretRef *v1common.SecretKeySelector `json:"keyBase64SecretRef,omitempty" tf:"-"`

	// (String, Sensitive) Key data in JSON Web Key format. Required if format is "jwk".
	// Key data in [JSON Web Key](https://developer.mozilla.org/en-US/docs/Web/API/SubtleCrypto/importKey#json_web_key) format. Required if `format` is "jwk".
	KeyJwkSecretRef *v1common.SecretKeySelector `json:"keyJwkSecretRef,omitempty" tf:"-"`
	...
	TextSecretRef *v1common.SecretKeySelector `json:"textSecretRef,omitempty" tf:"-"`
...
type WorkersScriptInitParameters struct {
	...
	// +kubebuilder:validation:Optional
	AccountIDRef *v1common.Reference `json:"accountIdRef,omitempty" tf:"-"`
