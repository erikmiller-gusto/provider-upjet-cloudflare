...
type ZeroTrustDLPCustomProfileInitParameters struct {
...
type ZeroTrustDLPCustomProfileObservation struct {
...
type ZeroTrustDLPCustomProfileParameters struct {
...
// ZeroTrustDLPCustomProfileSpec defines the desired state of ZeroTrustDLPCustomProfile
type ZeroTrustDLPCustomProfileSpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     ZeroTrustDLPCustomProfileParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider ZeroTrustDLPCustomProfileInitParameters `json:"initProvider,omitempty"`
}

// ZeroTrustDLPCustomProfileStatus defines the observed state of ZeroTrustDLPCustomProfile.
type ZeroTrustDLPCustomProfileStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        ZeroTrustDLPCustomProfileObservation `json:"atProvider,omitempty"`
}
...
// ZeroTrustDLPCustomProfile is the Schema for the ZeroTrustDLPCustomProfiles API.
...
type ZeroTrustDLPCustomProfile struct {
	...
	Spec   ZeroTrustDLPCustomProfileSpec   `json:"spec"`
	Status ZeroTrustDLPCustomProfileStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// ZeroTrustDLPCustomProfileList contains a list of ZeroTrustDLPCustomProfiles
type ZeroTrustDLPCustomProfileList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []ZeroTrustDLPCustomProfile `json:"items"`
}

// Repository type metadata.
var (
	ZeroTrustDLPCustomProfile_Kind             = "ZeroTrustDLPCustomProfile"
	ZeroTrustDLPCustomProfile_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: ZeroTrustDLPCustomProfile_Kind}.String()
	ZeroTrustDLPCustomProfile_KindAPIVersion   = ZeroTrustDLPCustomProfile_Kind + "." + CRDGroupVersion.String()
	ZeroTrustDLPCustomProfile_GroupVersionKind = CRDGroupVersion.WithKind(ZeroTrustDLPCustomProfile_Kind)
)

func init() {
	SchemeBuilder.Register(&ZeroTrustDLPCustomProfile{}, &ZeroTrustDLPCustomProfileList{})
}
