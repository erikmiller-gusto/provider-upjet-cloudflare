...
type StreamLiveInputInitParameters struct {
...
type StreamLiveInputObservation struct {
...
// StreamLiveInputSpec defines the desired state of StreamLiveInput
type StreamLiveInputSpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     StreamLiveInputParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider StreamLiveInputInitParameters `json:"initProvider,omitempty"`
}

// StreamLiveInputStatus defines the observed state of StreamLiveInput.
type StreamLiveInputStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        StreamLiveInputObservation `json:"atProvider,omitempty"`
}
...
// StreamLiveInput is the Schema for the StreamLiveInputs API.
...
type StreamLiveInput struct {
	...
	Spec              StreamLiveInputSpec   `json:"spec"`
	Status            StreamLiveInputStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// StreamLiveInputList contains a list of StreamLiveInputs
type StreamLiveInputList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []StreamLiveInput `json:"items"`
}

// Repository type metadata.
var (
	StreamLiveInput_Kind             = "StreamLiveInput"
	StreamLiveInput_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: StreamLiveInput_Kind}.String()
	StreamLiveInput_KindAPIVersion   = StreamLiveInput_Kind + "." + CRDGroupVersion.String()
	StreamLiveInput_GroupVersionKind = CRDGroupVersion.WithKind(StreamLiveInput_Kind)
)

func init() {
	SchemeBuilder.Register(&StreamLiveInput{}, &StreamLiveInputList{})
}
