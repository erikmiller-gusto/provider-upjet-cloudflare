...
type AssetsConfigInitParameters struct {
	...
	RunWorkerFirst *v1.JSON `json:"runWorkerFirst,omitempty" tf:"run_worker_first,omitempty"`
...
type AssetsInitParameters struct {
	...
	JwtSecretRef *v1common.LocalSecretKeySelector `json:"jwtSecretRef,omitempty" tf:"-"`
}
...
type BindingsInitParameters struct {
	...
	KeyBase64SecretRef *v1common.LocalSecretKeySelector `json:"keyBase64SecretRef,omitempty" tf:"-"`

	// (String, Sensitive) Key data in JSON Web Key format. Required if format is "jwk".
	// Key data in [JSON Web Key](https://developer.mozilla.org/en-US/docs/Web/API/SubtleCrypto/importKey#json_web_key) format. Required if `format` is "jwk".
	KeyJwkSecretRef *v1common.LocalSecretKeySelector `json:"keyJwkSecretRef,omitempty" tf:"-"`
	...
	TextSecretRef *v1common.LocalSecretKeySelector `json:"textSecretRef,omitempty" tf:"-"`
...
type WorkersScriptInitParameters struct {
	...
	// +kubebuilder:validation:Optional
	AccountIDRef *v1common.NamespacedReference `json:"accountIdRef,omitempty" tf:"-"`

	// Selector for a Account in account to populate accountId.
	// +kubebuilder:validation:Optional
	AccountIDSelector *v1common.NamespacedSelector `json:"accountIdSelector,omitempty" tf:"-"`
	...
	Limits *WorkersScriptLimitsInitParameters `json:"limits,omitempty" tf:"limits,omitempty"`
...
type WorkersScriptLimitsInitParameters struct {
...
type WorkersScriptLimitsObservation struct {
...
type WorkersScriptLimitsParameters struct {
...
type WorkersScriptObservation struct {
	...
	// (Attributes) Limits to apply for this Worker. (see below for nested schema)
	Limits *WorkersScriptLimitsObservation `json:"limits,omitempty" tf:"limits,omitempty"`
...
type WorkersScriptParameters struct {
	...
	// (Attributes) Limits to apply for this Worker. (see below for nested schema)
	// +kubebuilder:validation:Optional
	Limits *WorkersScriptLimitsParameters `json:"limits,omitempty" tf:"limits,omitempty"`
	...
	// (Attributes) Configuration for Smart Placement. (see below for nested schema)
	// +kubebuilder:validation:Optional
	Placement *WorkersScriptPlacementParameters `json:"placement,omitempty" tf:"placement,omitempty"`
...
type WorkersScriptPlacementInitParameters struct {
...
type WorkersScriptSpec struct {
	v2.ManagedResourceSpec `json:",inline"`
	ForProvider            WorkersScriptParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider WorkersScriptInitParameters `json:"initProvider,omitempty"`
}

// WorkersScriptStatus defines the observed state of WorkersScript.
type WorkersScriptStatus struct {
	v1common.ResourceStatus `json:",inline"`
	AtProvider              WorkersScriptObservation `json:"atProvider,omitempty"`
}
...
// WorkersScript is the Schema for the WorkersScripts API.
...
type WorkersScript struct {
	...
	Spec   WorkersScriptSpec   `json:"spec"`
	Status WorkersScriptStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// WorkersScriptList contains a list of WorkersScripts
type WorkersScriptList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []WorkersScript `json:"items"`
}

// Repository type metadata.
var (
	WorkersScript_Kind             = "WorkersScript"
	WorkersScript_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: WorkersScript_Kind}.String()
	WorkersScript_KindAPIVersion   = WorkersScript_Kind + "." + CRDGroupVersion.String()
	WorkersScript_GroupVersionKind = CRDGroupVersion.WithKind(WorkersScript_Kind)
)

func init() {
	SchemeBuilder.Register(&WorkersScript{}, &WorkersScriptList{})
}
