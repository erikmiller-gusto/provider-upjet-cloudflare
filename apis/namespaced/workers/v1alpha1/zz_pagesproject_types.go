...
type BuildConfigInitParameters struct {
	...
	WebAnalyticsTokenSecretRef *v1.LocalSecretKeySelector `json:"webAnalyticsTokenSecretRef,omitempty" tf:"-"`
}
...
type PagesProjectInitParameters struct {
	...
	// (Attributes) Configs for the project source control. (see below for nested schema)
	Source *PagesProjectSourceInitParameters `json:"source,omitempty" tf:"source,omitempty"`
}
...
type PagesProjectObservation struct {
	...
	// (Attributes) Configs for the project source control. (see below for nested schema)
	Source *PagesProjectSourceObservation `json:"source,omitempty" tf:"source,omitempty"`
...
type PagesProjectParameters struct {
	...
	// (Attributes) Configs for the project source control. (see below for nested schema)
	// +kubebuilder:validation:Optional
	Source *PagesProjectSourceParameters `json:"source,omitempty" tf:"source,omitempty"`
}

type PagesProjectSourceConfigInitParameters struct {
...
type PagesProjectSourceConfigObservation struct {
...
type PagesProjectSourceConfigParameters struct {
...
type PagesProjectSourceInitParameters struct {

	// (Attributes) (see below for nested schema)
	Config *PagesProjectSourceConfigInitParameters `json:"config,omitempty" tf:"config,omitempty"`
...
type PagesProjectSourceObservation struct {

	// (Attributes) (see below for nested schema)
	Config *PagesProjectSourceConfigObservation `json:"config,omitempty" tf:"config,omitempty"`
...
type PagesProjectSourceParameters struct {

	// (Attributes) (see below for nested schema)
	// +kubebuilder:validation:Optional
	Config *PagesProjectSourceConfigParameters `json:"config" tf:"config,omitempty"`
...
type PagesProjectSpec struct {
	...
	ForProvider            PagesProjectParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider PagesProjectInitParameters `json:"initProvider,omitempty"`
}
...
// PagesProject is the Schema for the PagesProjects API.
...
// PagesProjectList contains a list of PagesProjects
...
var (
	PagesProject_Kind             = "PagesProject"
	PagesProject_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: PagesProject_Kind}.String()
	PagesProject_KindAPIVersion   = PagesProject_Kind + "." + CRDGroupVersion.String()
	PagesProject_GroupVersionKind = CRDGroupVersion.WithKind(PagesProject_Kind)
)
