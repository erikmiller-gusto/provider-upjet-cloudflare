...
type LoadBalancerPoolInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/crossplane-contrib/provider-upjet-cloudflare/apis/namespaced/loadbalancer/v1alpha1.LoadBalancerMonitor
	...
	// Reference to a LoadBalancerMonitor in loadbalancer to populate monitor.
	// +kubebuilder:validation:Optional
	MonitorRef *v1.NamespacedReference `json:"monitorRef,omitempty" tf:"-"`

	// Selector for a LoadBalancerMonitor in loadbalancer to populate monitor.
	// +kubebuilder:validation:Optional
	MonitorSelector *v1.NamespacedSelector `json:"monitorSelector,omitempty" tf:"-"`
