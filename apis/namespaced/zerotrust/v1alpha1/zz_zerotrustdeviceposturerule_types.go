...
type ZeroTrustDevicePostureRuleInitParameters struct {
...
type ZeroTrustDevicePostureRuleObservation struct {
...
type ZeroTrustDevicePostureRuleParameters struct {
...
// ZeroTrustDevicePostureRuleSpec defines the desired state of ZeroTrustDevicePostureRule
type ZeroTrustDevicePostureRuleSpec struct {
	v2.ManagedResourceSpec `json:",inline"`
	ForProvider            ZeroTrustDevicePostureRuleParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider ZeroTrustDevicePostureRuleInitParameters `json:"initProvider,omitempty"`
}

// ZeroTrustDevicePostureRuleStatus defines the observed state of ZeroTrustDevicePostureRule.
type ZeroTrustDevicePostureRuleStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        ZeroTrustDevicePostureRuleObservation `json:"atProvider,omitempty"`
}
...
// ZeroTrustDevicePostureRule is the Schema for the ZeroTrustDevicePostureRules API.
...
type ZeroTrustDevicePostureRule struct {
	...
	Spec   ZeroTrustDevicePostureRuleSpec   `json:"spec"`
	Status ZeroTrustDevicePostureRuleStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// ZeroTrustDevicePostureRuleList contains a list of ZeroTrustDevicePostureRules
type ZeroTrustDevicePostureRuleList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []ZeroTrustDevicePostureRule `json:"items"`
}

// Repository type metadata.
var (
	ZeroTrustDevicePostureRule_Kind             = "ZeroTrustDevicePostureRule"
	ZeroTrustDevicePostureRule_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: ZeroTrustDevicePostureRule_Kind}.String()
	ZeroTrustDevicePostureRule_KindAPIVersion   = ZeroTrustDevicePostureRule_Kind + "." + CRDGroupVersion.String()
	ZeroTrustDevicePostureRule_GroupVersionKind = CRDGroupVersion.WithKind(ZeroTrustDevicePostureRule_Kind)
)

func init() {
	SchemeBuilder.Register(&ZeroTrustDevicePostureRule{}, &ZeroTrustDevicePostureRuleList{})
}
