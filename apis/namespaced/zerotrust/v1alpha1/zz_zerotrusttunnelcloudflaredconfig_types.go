...
type ZeroTrustTunnelCloudflaredConfigConfigInitParameters struct {
...
type ZeroTrustTunnelCloudflaredConfigConfigObservation struct {
...
type ZeroTrustTunnelCloudflaredConfigConfigParameters struct {
...
type ZeroTrustTunnelCloudflaredConfigInitParameters struct {
	...
	Config *ZeroTrustTunnelCloudflaredConfigConfigInitParameters `json:"config,omitempty" tf:"config,omitempty"`
	...
	// UUID of the tunnel.
	// +crossplane:generate:reference:type=github.com/crossplane-contrib/provider-upjet-cloudflare/apis/namespaced/zerotrust/v1alpha1.ZeroTrustTunnelCloudflared
	...
	// +kubebuilder:validation:Optional
	TunnelIDRef *v1.NamespacedReference `json:"tunnelIdRef,omitempty" tf:"-"`

	// Selector for a ZeroTrustTunnelCloudflared in zerotrust to populate tunnelId.
	// +kubebuilder:validation:Optional
	TunnelIDSelector *v1.NamespacedSelector `json:"tunnelIdSelector,omitempty" tf:"-"`
}

type ZeroTrustTunnelCloudflaredConfigObservation struct {
	...
	// (Attributes) The tunnel configuration and ingress rules. (see below for nested schema)
	Config *ZeroTrustTunnelCloudflaredConfigConfigObservation `json:"config,omitempty" tf:"config,omitempty"`
...
type ZeroTrustTunnelCloudflaredConfigParameters struct {
	...
	// (Attributes) The tunnel configuration and ingress rules. (see below for nested schema)
	// +kubebuilder:validation:Optional
	Config *ZeroTrustTunnelCloudflaredConfigConfigParameters `json:"config,omitempty" tf:"config,omitempty"`
...
// ZeroTrustTunnelCloudflaredConfigSpec defines the desired state of ZeroTrustTunnelCloudflaredConfig
type ZeroTrustTunnelCloudflaredConfigSpec struct {
	v2.ManagedResourceSpec `json:",inline"`
	ForProvider            ZeroTrustTunnelCloudflaredConfigParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider ZeroTrustTunnelCloudflaredConfigInitParameters `json:"initProvider,omitempty"`
}

// ZeroTrustTunnelCloudflaredConfigStatus defines the observed state of ZeroTrustTunnelCloudflaredConfig.
type ZeroTrustTunnelCloudflaredConfigStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        ZeroTrustTunnelCloudflaredConfigObservation `json:"atProvider,omitempty"`
}
...
// ZeroTrustTunnelCloudflaredConfig is the Schema for the ZeroTrustTunnelCloudflaredConfigs API.
...
type ZeroTrustTunnelCloudflaredConfig struct {
	...
	Spec              ZeroTrustTunnelCloudflaredConfigSpec   `json:"spec"`
	Status            ZeroTrustTunnelCloudflaredConfigStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// ZeroTrustTunnelCloudflaredConfigList contains a list of ZeroTrustTunnelCloudflaredConfigs
type ZeroTrustTunnelCloudflaredConfigList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []ZeroTrustTunnelCloudflaredConfig `json:"items"`
}

// Repository type metadata.
var (
	ZeroTrustTunnelCloudflaredConfig_Kind             = "ZeroTrustTunnelCloudflaredConfig"
	ZeroTrustTunnelCloudflaredConfig_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: ZeroTrustTunnelCloudflaredConfig_Kind}.String()
	ZeroTrustTunnelCloudflaredConfig_KindAPIVersion   = ZeroTrustTunnelCloudflaredConfig_Kind + "." + CRDGroupVersion.String()
	ZeroTrustTunnelCloudflaredConfig_GroupVersionKind = CRDGroupVersion.WithKind(ZeroTrustTunnelCloudflaredConfig_Kind)
)

func init() {
	SchemeBuilder.Register(&ZeroTrustTunnelCloudflaredConfig{}, &ZeroTrustTunnelCloudflaredConfigList{})
}
