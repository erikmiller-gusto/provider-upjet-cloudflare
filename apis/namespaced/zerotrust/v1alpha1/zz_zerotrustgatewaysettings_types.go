...
type ZeroTrustGatewaySettingsInitParameters struct {
...
type ZeroTrustGatewaySettingsObservation struct {
...
type ZeroTrustGatewaySettingsParameters struct {
...
// ZeroTrustGatewaySettingsSpec defines the desired state of ZeroTrustGatewaySettings
type ZeroTrustGatewaySettingsSpec struct {
	v2.ManagedResourceSpec `json:",inline"`
	ForProvider            ZeroTrustGatewaySettingsParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider ZeroTrustGatewaySettingsInitParameters `json:"initProvider,omitempty"`
}

// ZeroTrustGatewaySettingsStatus defines the observed state of ZeroTrustGatewaySettings.
type ZeroTrustGatewaySettingsStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        ZeroTrustGatewaySettingsObservation `json:"atProvider,omitempty"`
}
...
// ZeroTrustGatewaySettings is the Schema for the ZeroTrustGatewaySettingss API.
...
type ZeroTrustGatewaySettings struct {
	...
	Spec              ZeroTrustGatewaySettingsSpec   `json:"spec"`
	Status            ZeroTrustGatewaySettingsStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// ZeroTrustGatewaySettingsList contains a list of ZeroTrustGatewaySettingss
type ZeroTrustGatewaySettingsList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []ZeroTrustGatewaySettings `json:"items"`
}

// Repository type metadata.
var (
	ZeroTrustGatewaySettings_Kind             = "ZeroTrustGatewaySettings"
	ZeroTrustGatewaySettings_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: ZeroTrustGatewaySettings_Kind}.String()
	ZeroTrustGatewaySettings_KindAPIVersion   = ZeroTrustGatewaySettings_Kind + "." + CRDGroupVersion.String()
	ZeroTrustGatewaySettings_GroupVersionKind = CRDGroupVersion.WithKind(ZeroTrustGatewaySettings_Kind)
)

func init() {
	SchemeBuilder.Register(&ZeroTrustGatewaySettings{}, &ZeroTrustGatewaySettingsList{})
}
