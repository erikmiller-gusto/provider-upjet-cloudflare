...
type ZeroTrustGatewayPolicyInitParameters struct {
...
type ZeroTrustGatewayPolicyObservation struct {
...
type ZeroTrustGatewayPolicyParameters struct {
...
// ZeroTrustGatewayPolicySpec defines the desired state of ZeroTrustGatewayPolicy
type ZeroTrustGatewayPolicySpec struct {
	v2.ManagedResourceSpec `json:",inline"`
	ForProvider            ZeroTrustGatewayPolicyParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider ZeroTrustGatewayPolicyInitParameters `json:"initProvider,omitempty"`
}

// ZeroTrustGatewayPolicyStatus defines the observed state of ZeroTrustGatewayPolicy.
type ZeroTrustGatewayPolicyStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        ZeroTrustGatewayPolicyObservation `json:"atProvider,omitempty"`
}
...
// ZeroTrustGatewayPolicy is the Schema for the ZeroTrustGatewayPolicys API.
...
type ZeroTrustGatewayPolicy struct {
	...
	Spec   ZeroTrustGatewayPolicySpec   `json:"spec"`
	Status ZeroTrustGatewayPolicyStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// ZeroTrustGatewayPolicyList contains a list of ZeroTrustGatewayPolicys
...
var (
	ZeroTrustGatewayPolicy_Kind             = "ZeroTrustGatewayPolicy"
	ZeroTrustGatewayPolicy_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: ZeroTrustGatewayPolicy_Kind}.String()
	ZeroTrustGatewayPolicy_KindAPIVersion   = ZeroTrustGatewayPolicy_Kind + "." + CRDGroupVersion.String()
	ZeroTrustGatewayPolicy_GroupVersionKind = CRDGroupVersion.WithKind(ZeroTrustGatewayPolicy_Kind)
)

func init() {
	SchemeBuilder.Register(&ZeroTrustGatewayPolicy{}, &ZeroTrustGatewayPolicyList{})
}
