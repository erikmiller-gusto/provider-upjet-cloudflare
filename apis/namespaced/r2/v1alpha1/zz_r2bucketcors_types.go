...
type R2BucketCORSInitParameters struct {
...
type R2BucketCORSObservation struct {
...
// R2BucketCORSSpec defines the desired state of R2BucketCORS
type R2BucketCORSSpec struct {
	v2.ManagedResourceSpec `json:",inline"`
	ForProvider            R2BucketCORSParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider R2BucketCORSInitParameters `json:"initProvider,omitempty"`
}

// R2BucketCORSStatus defines the observed state of R2BucketCORS.
type R2BucketCORSStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        R2BucketCORSObservation `json:"atProvider,omitempty"`
}
...
// R2BucketCORS is the Schema for the R2BucketCORSs API.
...
type R2BucketCORS struct {
	...
	Spec              R2BucketCORSSpec   `json:"spec"`
	Status            R2BucketCORSStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// R2BucketCORSList contains a list of R2BucketCORSs
type R2BucketCORSList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []R2BucketCORS `json:"items"`
}

// Repository type metadata.
var (
	R2BucketCORS_Kind             = "R2BucketCORS"
	R2BucketCORS_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: R2BucketCORS_Kind}.String()
	R2BucketCORS_KindAPIVersion   = R2BucketCORS_Kind + "." + CRDGroupVersion.String()
	R2BucketCORS_GroupVersionKind = CRDGroupVersion.WithKind(R2BucketCORS_Kind)
)

func init() {
	SchemeBuilder.Register(&R2BucketCORS{}, &R2BucketCORSList{})
}
