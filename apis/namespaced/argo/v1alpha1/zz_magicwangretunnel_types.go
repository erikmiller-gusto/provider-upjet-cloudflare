...
type MagicWANGRETunnelInitParameters struct {
...
type MagicWANGRETunnelObservation struct {
...
type MagicWANGRETunnelParameters struct {
...
// MagicWANGRETunnelSpec defines the desired state of MagicWANGRETunnel
type MagicWANGRETunnelSpec struct {
	v2.ManagedResourceSpec `json:",inline"`
	ForProvider            MagicWANGRETunnelParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider MagicWANGRETunnelInitParameters `json:"initProvider,omitempty"`
}

// MagicWANGRETunnelStatus defines the observed state of MagicWANGRETunnel.
type MagicWANGRETunnelStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        MagicWANGRETunnelObservation `json:"atProvider,omitempty"`
}
...
// MagicWANGRETunnel is the Schema for the MagicWANGRETunnels API.
...
type MagicWANGRETunnel struct {
	...
	Spec   MagicWANGRETunnelSpec   `json:"spec"`
	Status MagicWANGRETunnelStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// MagicWANGRETunnelList contains a list of MagicWANGRETunnels
type MagicWANGRETunnelList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []MagicWANGRETunnel `json:"items"`
}

// Repository type metadata.
var (
	MagicWANGRETunnel_Kind             = "MagicWANGRETunnel"
	MagicWANGRETunnel_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: MagicWANGRETunnel_Kind}.String()
	MagicWANGRETunnel_KindAPIVersion   = MagicWANGRETunnel_Kind + "." + CRDGroupVersion.String()
	MagicWANGRETunnel_GroupVersionKind = CRDGroupVersion.WithKind(MagicWANGRETunnel_Kind)
)

func init() {
	SchemeBuilder.Register(&MagicWANGRETunnel{}, &MagicWANGRETunnelList{})
}
