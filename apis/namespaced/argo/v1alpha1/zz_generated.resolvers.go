...
// ResolveReferences of this MagicWANGRETunnel.
func (mg *MagicWANGRETunnel) ResolveReferences(ctx context.Context, c client.Reader) error {
...
// ResolveReferences of this MagicWANIPSecTunnel.
func (mg *MagicWANIPSecTunnel) ResolveReferences(ctx context.Context, c client.Reader) error {
	r := reference.NewAPINamespacedResolver(c, mg)
...
// ResolveReferences of this MagicWANStaticRoute.
func (mg *MagicWANStaticRoute) ResolveReferences(ctx context.Context, c client.Reader) error {
	r := reference.NewAPINamespacedResolver(c, mg)
