...
type FirewallRuleFilterInitParameters struct {
...
type FirewallRuleFilterObservation struct {
...
type FirewallRuleFilterParameters struct {
...
type FirewallRuleInitParameters struct {
	...
	Filter *FirewallRuleFilterInitParameters `json:"filter,omitempty" tf:"filter,omitempty"`
...
type FirewallRuleObservation struct {
	...
	// (Attributes) (see below for nested schema)
	Filter *FirewallRuleFilterObservation `json:"filter,omitempty" tf:"filter,omitempty"`
...
type FirewallRuleParameters struct {
	...
	// (Attributes) (see below for nested schema)
	// +kubebuilder:validation:Optional
	Filter *FirewallRuleFilterParameters `json:"filter,omitempty" tf:"filter,omitempty"`
