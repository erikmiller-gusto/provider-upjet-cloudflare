...
type ActionResponseInitParameters struct {
...
type ActionResponseObservation struct {
...
type ActionResponseParameters struct {
...
type RateLimitActionInitParameters struct {
	...
	// (Attributes) A custom content type and reponse to return when the threshold is exceeded. The custom response configured in this object will override the custom error for the zone. This object is optional.
	// Notes: If you omit this object, Cloudflare will use the default HTML error page. If "mode" is "challenge", "managed_challenge", or "js_challenge", Cloudflare will use the zone challenge pages and you should not provide the "response" object. (see below for nested schema)
	Response *ActionResponseInitParameters `json:"response,omitempty" tf:"response,omitempty"`
...
type RateLimitActionObservation struct {
	...
	// (Attributes) A custom content type and reponse to return when the threshold is exceeded. The custom response configured in this object will override the custom error for the zone. This object is optional.
	// Notes: If you omit this object, Cloudflare will use the default HTML error page. If "mode" is "challenge", "managed_challenge", or "js_challenge", Cloudflare will use the zone challenge pages and you should not provide the "response" object. (see below for nested schema)
	Response *ActionResponseObservation `json:"response,omitempty" tf:"response,omitempty"`
...
type RateLimitActionParameters struct {
	...
	// Notes: If you omit this object, Cloudflare will use the default HTML error page. If "mode" is "challenge", "managed_challenge", or "js_challenge", Cloudflare will use the zone challenge pages and you should not provide the "response" object. (see below for nested schema)
	// +kubebuilder:validation:Optional
	Response *ActionResponseParameters `json:"response,omitempty" tf:"response,omitempty"`
...
type RateLimitInitParameters struct {
	...
	Action *RateLimitActionInitParameters `json:"action,omitempty" tf:"action,omitempty"`
...
type RateLimitObservation struct {
	...
	// (Attributes) The action to perform when the threshold of matched traffic within the configured period is exceeded. (see below for nested schema)
	Action *RateLimitActionObservation `json:"action,omitempty" tf:"action,omitempty"`
...
type RateLimitParameters struct {
	...
	// (Attributes) The action to perform when the threshold of matched traffic within the configured period is exceeded. (see below for nested schema)
	// +kubebuilder:validation:Optional
	Action *RateLimitActionParameters `json:"action,omitempty" tf:"action,omitempty"`
