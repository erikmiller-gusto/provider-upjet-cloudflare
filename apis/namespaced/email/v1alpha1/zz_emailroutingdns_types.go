...
type EmailRoutingDNSInitParameters struct {
...
type EmailRoutingDNSObservation struct {
...
type EmailRoutingDNSParameters struct {
...
// EmailRoutingDNSSpec defines the desired state of EmailRoutingDNS
type EmailRoutingDNSSpec struct {
	v2.ManagedResourceSpec `json:",inline"`
	ForProvider            EmailRoutingDNSParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider EmailRoutingDNSInitParameters `json:"initProvider,omitempty"`
}

// EmailRoutingDNSStatus defines the observed state of EmailRoutingDNS.
type EmailRoutingDNSStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        EmailRoutingDNSObservation `json:"atProvider,omitempty"`
}
...
// EmailRoutingDNS is the Schema for the EmailRoutingDNSs API.
...
type EmailRoutingDNS struct {
	...
	Spec              EmailRoutingDNSSpec   `json:"spec"`
	Status            EmailRoutingDNSStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// EmailRoutingDNSList contains a list of EmailRoutingDNSs
type EmailRoutingDNSList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []EmailRoutingDNS `json:"items"`
}

// Repository type metadata.
var (
	EmailRoutingDNS_Kind             = "EmailRoutingDNS"
	EmailRoutingDNS_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: EmailRoutingDNS_Kind}.String()
	EmailRoutingDNS_KindAPIVersion   = EmailRoutingDNS_Kind + "." + CRDGroupVersion.String()
	EmailRoutingDNS_GroupVersionKind = CRDGroupVersion.WithKind(EmailRoutingDNS_Kind)
)

func init() {
	SchemeBuilder.Register(&EmailRoutingDNS{}, &EmailRoutingDNSList{})
}
