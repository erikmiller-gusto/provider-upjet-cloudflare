...
// ResolveReferences of this EmailRoutingAddress.
func (mg *EmailRoutingAddress) ResolveReferences(ctx context.Context, c client.Reader) error {
...
// ResolveReferences of this EmailRoutingCatchAll.
func (mg *EmailRoutingCatchAll) ResolveReferences(ctx context.Context, c client.Reader) error {
	r := reference.NewAPINamespacedResolver(c, mg)
...
// ResolveReferences of this EmailRoutingDNS.
func (mg *EmailRoutingDNS) ResolveReferences(ctx context.Context, c client.Reader) error {
	r := reference.NewAPINamespacedResolver(c, mg)
...
// ResolveReferences of this EmailRoutingRule.
func (mg *EmailRoutingRule) ResolveReferences(ctx context.Context, c client.Reader) error {
	r := reference.NewAPINamespacedResolver(c, mg)
...
// ResolveReferences of this EmailRoutingSettings.
func (mg *EmailRoutingSettings) ResolveReferences(ctx context.Context, c client.Reader) error {
	r := reference.NewAPINamespacedResolver(c, mg)
