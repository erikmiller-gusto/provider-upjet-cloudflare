...
type DNSFirewallInitParameters struct {
...
type DNSFirewallObservation struct {
...
type DNSFirewallParameters struct {
...
// DNSFirewallSpec defines the desired state of DNSFirewall
type DNSFirewallSpec struct {
	v2.ManagedResourceSpec `json:",inline"`
	ForProvider            DNSFirewallParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider DNSFirewallInitParameters `json:"initProvider,omitempty"`
}

// DNSFirewallStatus defines the observed state of DNSFirewall.
type DNSFirewallStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        DNSFirewallObservation `json:"atProvider,omitempty"`
}
...
// DNSFirewall is the Schema for the DNSFirewalls API.
...
type DNSFirewall struct {
	...
	Spec   DNSFirewallSpec   `json:"spec"`
	Status DNSFirewallStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// DNSFirewallList contains a list of DNSFirewalls
type DNSFirewallList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []DNSFirewall `json:"items"`
}

// Repository type metadata.
var (
	DNSFirewall_Kind             = "DNSFirewall"
	DNSFirewall_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: DNSFirewall_Kind}.String()
	DNSFirewall_KindAPIVersion   = DNSFirewall_Kind + "." + CRDGroupVersion.String()
	DNSFirewall_GroupVersionKind = CRDGroupVersion.WithKind(DNSFirewall_Kind)
)

func init() {
	SchemeBuilder.Register(&DNSFirewall{}, &DNSFirewallList{})
}
